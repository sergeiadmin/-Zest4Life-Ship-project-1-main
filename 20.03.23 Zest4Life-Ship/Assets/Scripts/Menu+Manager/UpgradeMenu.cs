...
public class UpgradeMenu : MonoBehaviour
{
    ...
    private void Update()
    {
        upgradeOilLevelButton.GetComponent<TextMeshProUGUI>().text = "Скорость за: " + _oilLevelValue;
        upgradeOilCapacityButton.GetComponent<TextMeshProUGUI>().text = "Объём хранилища за: " + _oilCapacityValue;
        upgradeCarrierSpeedButton.GetComponent<TextMeshProUGUI>().text = "Улучшить за: " + _carrierSpeedValue;
        upgradeCarrierCapacityButton.GetComponent<TextMeshProUGUI>().text = "Улучшить за: " + _carrierCapacityValue;
        upgradeStorageCapacityButton.GetComponent<TextMeshProUGUI>().text = "Улучшить за: " + _storageCapacityValue;
        upgradeMainBuildingLevelText.GetComponent<TextMeshProUGUI>().text = "Улучшить за: " + _mainBuildingLevelValue;
    }
